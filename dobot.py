...
class Dobot:
    ...
    def _get_queued_cmd_current_index(self):
        msg = Message()
        msg.id = CommunicationProtocolIDs.GET_QUEUED_CMD_CURRENT_INDEX.value
    ...
    def _get_pose(self):
        msg = Message()
        msg.id = CommunicationProtocolIDs.GET_POSE.value
        response = self._send_command(msg)
    ...
    def _set_cp_cmd(self, x, y, z):
        msg = Message()
        msg.id = CommunicationProtocolIDs.SET_CP_CMD.value
        msg.ctrl = ControlValues.THREE.value
    ...
    def _set_end_effector_gripper(self, enable=False):
        msg = Message()
        msg.id = CommunicationProtocolIDs.SET_GET_END_EFFECTOR_GRIPPER.value
        msg.ctrl = ControlValues.THREE.value
    ...
    def _set_end_effector_suction_cup(self, enable=False):
        msg = Message()
        msg.id = CommunicationProtocolIDs.SET_GET_END_EFFECTOR_SUCTION_CUP.value
        msg.ctrl = ControlValues.THREE.value
        msg.params = bytearray([])
        msg.params.extend(bytearray([0x01]))
        if enable is True:
    ...
    def _set_ptp_joint_params(self, v_x, v_y, v_z, v_r, a_x, a_y, a_z, a_r):
        msg = Message()
        msg.id = CommunicationProtocolIDs.SET_GET_PTP_JOINT_PARAMS.value
        msg.ctrl = ControlValues.THREE.value
        msg.params = bytearray([])
    ...
    def _set_ptp_coordinate_params(self, velocity, acceleration):
        msg = Message()
        msg.id = CommunicationProtocolIDs.SET_GET_PTP_COORDINATE_PARAMS.value
        msg.ctrl = ControlValues.THREE.value
        msg.params = bytearray([])
    ...
    def _set_ptp_jump_params(self, jump, limit):
        msg = Message()
        msg.id = CommunicationProtocolIDs.SET_GET_PTP_JUMP_PARAMS.value
        msg.ctrl = ControlValues.THREE.value
        msg.params = bytearray([])
    ...
    def _set_ptp_common_params(self, velocity, acceleration):
        msg = Message()
        msg.id = CommunicationProtocolIDs.SET_GET_PTP_COMMON_PARAMS.value
        msg.ctrl = ControlValues.THREE.value
        msg.params = bytearray([])
        msg.params.extend(bytearray(struct.pack('f', velocity)))
        msg.params.extend(bytearray(struct.pack('f', acceleration)))
    ...
    def _set_ptp_cmd(self, x, y, z, r, mode, wait):
        msg = Message()
        msg.id = CommunicationProtocolIDs.SET_PTP_CMD.value
        msg.ctrl = ControlValues.THREE.value
        msg.params = bytearray([])
    ...
    def _set_queued_cmd_clear(self):
        msg = Message()
        msg.id = CommunicationProtocolIDs.SET_QUEUED_CMD_CLEAR.value
        msg.ctrl = ControlValues.ONE.value
        return self._send_command(msg)
    ...
    def _set_queued_cmd_start_exec(self):
        msg = Message()
        msg.id = CommunicationProtocolIDs.SET_QUEUED_CMD_START_EXEC.value
        msg.ctrl = ControlValues.ONE.value
        return self._send_command(msg)
    ...
    def _set_queued_cmd_stop_exec(self):
        msg = Message()
        msg.id = CommunicationProtocolIDs.SET_QUEUED_CMD_STOP_EXEC.value.value
        msg.ctrl = ControlValues.ONE.value.value
        return self._send_command(msg)
    ...
    def move_to(self, x, y, z, r, wait=False):
        self._set_ptp_cmd(x, y, z, r, mode=PTPMode.MOVL_XYZ.value, wait=wait)
